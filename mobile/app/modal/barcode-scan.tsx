    ...
    <View style={s.container}>
      ...
      >
        <SafeAreaView style={s.overlay}>
          ...
          <Text style={s.hint}>
            {loading ? '식품 정보 불러오는 중...' : '바코드를 스캔 영역에 맞춰주세요'}
          </Text>
...
const s = StyleSheet.create({
  ...
  closeBtn: { alignSelf: 'flex-end', marginRight: 20, backgroundColor: 'rgba(0,0,0,0.5)', borderRadius: 20, padding: 8 },
  ...
  retryBtn: { backgroundColor: Colors.primary, borderRadius: 14, paddingHorizontal: 32, paddingVertical: 12 },
  retryText: { color: '#fff', fontSize: 15, fontWeight: '700' },
  permText: { color: Colors.textPrimary, fontSize: 16, textAlign: 'center', marginBottom: 20, marginTop: 40 },
  permBtn: { backgroundColor: Colors.primary, borderRadius: 14, paddingHorizontal: 32, paddingVertical: 12, alignSelf: 'center' },
